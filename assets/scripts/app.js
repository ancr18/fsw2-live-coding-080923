...
class ShoppingCart {
    ...
    render() {
        ...
        //properti yang tidak perlu masuk constructor
...
class ProductList {
    products = [
        new Product('bantal',
            ...
            'ini bantal empuk banget loooh',10000),

        new Product('karpet',
        'https://cdn2.tstatic.net/travel/foto/bank/images/ilustrasi-karpet-terbang-aladdin.jpg','ini karpet bisa terbang cuuy, coba beli aja',
        30000,
        ),
    ]
